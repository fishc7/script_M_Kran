console.log('📄 extract_numbers.js загружается...');
console.log('🔧 CSP отключен для тестирования');

// Функция для показа модального окна извлечения чисел
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚨 === Инициализация функций извлечения чисел === 🚨');
    console.log('📁 Файл extract_numbers.js загружен успешно!');
    ...
    // Обработчик для карточки "Извлечение чисел"
